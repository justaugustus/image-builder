...
# uses powershell splatting: https://stackoverflow.com/questions/51219038/can-you-splat-positional-arguments-in-powershell/51219535#51219535
{{ kubernetes_install_path }}/kubelet.exe @args